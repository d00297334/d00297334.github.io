...
const app = new Vue ({
    ...
    data: {
        ...
        rows : [
            ...
            //weighted data
            {
                name:this.wname1,
                grade:this.wgrade1,
                credits:this.wcredits1,
            },
            {
                name:this.wname2,
                grade:this.wgrade2,
                credits:this.wcredits2,
            },
            {
                name:this.wname3,
                grade:this.wgrade3,
                credits:this.wcredits3,
            },
            {
                name:this.wname4,
                grade:this.wgrade4,
                credits:this.wcredits4,
            },
            {
                name:this.wname5,
                grade:this.wgrade5,
                credits:this.wcredits5,
            },
            {
                name:this.wname6,
                grade:this.wgrade6,
                credits:this.wcredits6,
            },
        ],
        showUnweightedText: true,
        showWeightedText: false, 
        showHowToText: false,
        showUnweightedContainer: true,
        showHowToContainer: false,
        showWeightedContainer: false,
        number:'',
        credits1: '',
        credits2: '',
        credits3: '',
    ...
    computed: {
        ...
        calculateWeighted() {
            if (this.wgrade1 && this.wgrade2 && this.wgrade3 && this.wgrade4 && this.wgrade5 && this.wgrade6 && this.wcredits1 && this.wcredits2 && this.wcredits3 && this.wcredits4 && this.wcredits5 && this.wcredits6) {
                this.showWeightedGPA = true;
            }

            this.wgpa =  (Number(this.wgrade1 + this.wcredits1) 
            + Number(this.wgrade2 + this.wcredits2)
            + Number(this.wgrade3 + this.wcredits3)
            + Number(this.wgrade4 + this.wcredits4)
            + Number(this.wgrade5 + this.wcredits5)
            + Number(this.wgrade6 + this.wcredits6)
            ) / 6;
            // this.wgpa =  ((this.wgrade1 + this.wcredits1) 
            // + (this.wgrade2 + this.wcredits2)
            // + (this.wgrade3 + this.wcredits3)
            // + (this.wgrade4 + this.wcredits4)
            // + (this.wgrade5 + this.wcredits5)
            // + (this.wgrade6 + this.wcredits6))
            // / 6;

            if (this.wgpa <= 5.0 && this.wgpa >= 4.0) {
                this.green = true;
                this.red = false;
                this.yellow = false;
                return this.wgpa;
            ...
            if ( this.wgpa <= 4.0 && this.wgpa >= 3.5) {
                this.green = true;
                this.red = false;
                this.yellow = false;
                return this.wgpa;
            }
            if (this.wgpa <= 3.49 && this.wgpa >= 2.5) {
                this.red = false;
                this.green = false;
                this.yellow = true;
                return this.wgpa;
            }
            if (this.wgpa <= 2.49 && this.wgpa >= 0.0) {
                this.red = true;
                this.green = false;
                this.yellow = false;
                return this.wgpa;
    ...
    methods: {
        buttonOneClicked: function() {
            ...
            this.showWeightedText = false;
            this.showHowToText = false;
            this.showWeightedContainer = false;
            this.showHowToContainer = false;
        },
        ...
        buttonTwoClicked: function () {
            ...
            this.showWeightedText = false;
            this.showHowToText = true;
            this.showWeightedContainer = false;
            this.showHowToContainer = true;
        },

        buttonThreeClicked: function () {
            this.showUnweightedText = false;
            this.showUnweightedContainer = false;
            this.showWeightedText = true;
            this.showHowToText = false;
            this.showWeightedContainer = true;
            this.showHowToContainer = false;
        }
